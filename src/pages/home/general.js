...
import ST from '../../assets/img/s.jpg';
import DS from '../../assets/img/d.jpg';
import PS from '../../assets/img/p.jpg';
import XT from '../../assets/img/x.jpg';
import HT from '../../assets/img/ht.jpg';
import DT from '../../assets/img/dd.jpg';
            ...
            <div className="row">
                <div style={{ justifyContent: 'center' }} className="col-md-7">
                    ...
                    <div style={{ display: 'flex', justifyContent: 'center', marginTop: '50px' }}>
                        ...
                        <Link to="/SearchBar" ><button id='garena' style={{ marginRight: '50px', width: '220px' }}>Khám Phá Thêm Các Vị Tướng</button></Link>
                        <Link to="/register"> <button id='garena'> <span style={{ display: 'block', textAlign: 'center' }} >Đăng Kí</span>
                        </button> </Link>
                    </div>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'center' }} className="button-container">
                            <button onClick={() => handleImageClick('image1')} style={{ margin: '0 10px' }}>
                                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                                    ...
                                    <span className="span" style={{ display: 'block', textAlign: 'center' }}>Sát Thủ</span>
                                </div>
                            </button>
                            <button onClick={() => handleImageClick('image2')} style={{ margin: '0 10px' }}>
                                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                                    ...
                                    <span className="span" style={{ display: 'block', textAlign: 'center' }}>Đấu Sĩ</span>
                                </div>
                            </button>
                            ...
                            <button onClick={() => handleImageClick('image3')} style={{ margin: '0 10px' }}>
                                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                                    ...
                                    <span className="span" style={{ display: 'block', textAlign: 'center' }}>Pháp Sư</span>
                                </div>
                            </button>
                            ...
                            <button onClick={() => handleImageClick('image4')} style={{ margin: '0 10px' }}>
                                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                                    ...
                                    <span className="span" style={{ display: 'block', textAlign: 'center' }}>Xạ Thủ</span>
                                </div>
                            </button>
                            ...
                            <button onClick={() => handleImageClick('image5')} style={{ margin: '0 10px' }}>
                                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                                    ...
                                    <span className="span" style={{ display: 'block', textAlign: 'center' }}>Hỗ Trợ</span>
                                </div>
                            </button>
                            ...
                            <button onClick={() => handleImageClick('image6')} style={{ margin: '0 10px' }}>
                                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                                    ...
                                    <span className="span" style={{ display: 'block', textAlign: 'center' }}>Đỡ Đòn</span>
                                </div>
                            </button>
                        </div>
