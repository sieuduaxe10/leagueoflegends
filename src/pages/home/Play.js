...
const Section = () => {
    ...
    const [backgroundImage, setBackgroundImage] = useState(AatroxQ);
    ...
    const handleImageClick = (image) => {
        ...
        switch (image) {
            case 'image1':
                setBackgroundImage(AatroxQ);
                break;
            case 'image2':
                setBackgroundImage(Aatrox_Passive);
                break;
            case 'image3':
                setBackgroundImage(AatroxW);
                break;
            case 'image4':
                setBackgroundImage(AatroxR);
                break;
            default:
                setBackgroundImage(Aatrox_Passive); // Mặc định là hình ảnh P
                break;
        }
    };
    ...
    return (
<section id='play' className="container-fluid section-name padding-y " style={{ backgroundImage: `url(${backgroundImage})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat' }}>
            <div className="row">
                ...
                <div style={{ marginTop: '400px' }} className="col-md-3">
                    ...
                    <Link to="/register" style={{ width: '200px', textAlign: 'center', color: '#f8fafc' }} className="codepen-button">
                        <span>Đăng Kí</span>
                    </Link>
                </div>
